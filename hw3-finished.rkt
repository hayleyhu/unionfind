...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname hw3-finished) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp")))))
#|
HW3: Union-Find
...
(define (same-set? uf obj1 obj2)
  (equal? (find uf obj1) (find uf obj2)))
;;;; My function is 2 lines ;;;;
...
(define (reparent uf child parent)
   (begin 
     (if (not (simple-same-set? uf child parent))
         (local [(define newWeight (+ (get-weight uf child) (get-weight uf parent)))] 
           (map (lambda (x) (if (or (simple-same-set? uf x child) (simple-same-set? uf x parent))
...
(define (simple-same-set? uf obj1 obj2)
